...
try
{
    title=request.getParameter("abc");
							   ...
							   <div class="movie-title">
								...
								<div class="movie-add">
								  ...
								  <form> <input type="button" class="btn btn-primary" value="Buy Now" onclick="window.location.href='pay.html'" style="float:right;" /> </form>
                                                                  <form action="newjsp.jsp"> <input name="abc" type="submit" class="btn btn-primary" value=<%=rs.getString("title")%>  style="float:left;" /></form>
